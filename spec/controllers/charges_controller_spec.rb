...
RSpec.describe ChargesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested charge as @charge" do
      charge = Charge.create! valid_attributes
      get :show, params: {id: charge.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested charge as @charge" do
      charge = Charge.create! valid_attributes
      get :edit, params: {id: charge.to_param}, session: valid_session
      expect(assigns(:charge)).to eq(charge)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Charge" do
        expect {
          post :create, params: {charge: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved charge as @charge" do
        post :create, params: {charge: invalid_attributes}, session: valid_session
        expect(assigns(:charge)).to be_a_new(Charge)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested charge" do
        charge = Charge.create! valid_attributes
        put :update, params: {id: charge.to_param, charge: new_attributes}, session: valid_session
        charge.reload
      ...
      it "assigns the requested charge as @charge" do
        charge = Charge.create! valid_attributes
        put :update, params: {id: charge.to_param, charge: valid_attributes}, session: valid_session
        expect(assigns(:charge)).to eq(charge)
      end
    ...
    context "with invalid params" do
      it "assigns the charge as @charge" do
        charge = Charge.create! valid_attributes
        put :update, params: {id: charge.to_param, charge: invalid_attributes}, session: valid_session
        expect(assigns(:charge)).to eq(charge)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested charge" do
      charge = Charge.create! valid_attributes
      expect {
        delete :destroy, params: {id: charge.to_param}, session: valid_session
      }.to change(Charge, :count).by(-1)
    end
